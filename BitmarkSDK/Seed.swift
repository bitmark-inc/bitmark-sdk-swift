...
public struct Seed {
    ...
    public init(fromBase58 base58String: String, version: Int = Config.SeedConfig.version) throws {
        ...
        // Verify the checksum
        let checksumVerification = rest.sha3Compute(length: 256).slice(start: 0, end: Config.SeedConfig.checksumLength)
    ...
    public var base58String: String {
        ...
        // Add checksum
        let checksum = exportedSeed.sha3Compute(length: 256).slice(start: 0, end: Config.SeedConfig.checksumLength)
