...
let bigZero = BigUInt(0)

public func decode(_ b: String) -> Data? {
    return decodeAlphabet(b, alphabet: BTCAlphabet)
}

public func encode(_ b: Data) -> String {
    return encodeAlphabet(b, alphabet: BTCAlphabet)
}

func decodeAlphabet(_ b: String, alphabet: String) -> Data? {
...
func encodeAlphabet(_ byteSlice: Data, alphabet: String) -> String {
